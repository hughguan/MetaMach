...
<p align="center">
  ...
  <img alt="Tests: 195" src="https://img.shields.io/badge/tests-195%20(CI%20green)-22c55e.svg">
...
- **195 tests**: all pass, 0 ignored
- **CI gates**: `cargo fmt`, `cargo clippy -D warnings`, `cargo test --workspace` (195 tests)
