...
<p align="center">
  ...
  <img alt="Tests: 193" src="https://img.shields.io/badge/tests-193%20(CI%20green)-22c55e.svg">
...
- **193 tests**: all pass, 0 ignored
- **CI gates**: `cargo fmt`, `cargo clippy -D warnings`, `cargo test --workspace` (193 tests)
