...
<p align="center">
  ...
  <img alt="Tests: 198" src="https://img.shields.io/badge/tests-198%20(CI%20green)-22c55e.svg">
...
- **198 tests**: all pass, 0 ignored
- **CI gates**: `cargo fmt`, `cargo clippy -D warnings`, `cargo test --workspace` (198 tests)
