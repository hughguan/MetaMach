...
<p align="center">
  ...
  <img alt="Tests: 196" src="https://img.shields.io/badge/tests-196%20(CI%20green)-22c55e.svg">
...
- **196 tests**: all pass, 0 ignored
- **CI gates**: `cargo fmt`, `cargo clippy -D warnings`, `cargo test --workspace` (196 tests)
