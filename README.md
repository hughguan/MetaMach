...
<p align="center">
  ...
  <img alt="Tests: 197" src="https://img.shields.io/badge/tests-197%20(CI%20green)-22c55e.svg">
...
- **197 tests**: all pass, 0 ignored
- **CI gates**: `cargo fmt`, `cargo clippy -D warnings`, `cargo test --workspace` (197 tests)
