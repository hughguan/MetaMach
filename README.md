...
<p align="center">
  ...
  <img alt="Tests: 194" src="https://img.shields.io/badge/tests-194%20(CI%20green)-22c55e.svg">
...
- **194 tests**: all pass, 0 ignored
- **CI gates**: `cargo fmt`, `cargo clippy -D warnings`, `cargo test --workspace` (194 tests)
