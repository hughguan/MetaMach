...
| **Status** | ✅ Implemented — 0.7.0 (Amends ADR-001, ADR-007, ADR-031). |
...
| **Status** | 🔄 Phase 1 Implemented / Phase 2 Spec'd Only — 0.7.0 (Amends ADR-010, ADR-019; Phase 2 depends on ADR-033). |
