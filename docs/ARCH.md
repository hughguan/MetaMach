# MetaMach 0.7.0 — System Architecture
...
- **On/Offboarding:**
    ...
    - _Onboard:_ The Factory Director executes `janus init`. The Daemon takes over with the standard onboarding process:
...
MetaMach 0.5.0 implements an industrial-grade isolation scheme of "independent brain monitoring, shadow client passthrough, physical session attachment, data logical multi-tenancy":
